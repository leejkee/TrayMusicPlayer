...
private:
    ...
    constexpr static int VIEW_TEXT_LEFT_PADDING = VIEW_PLAY_BUTTON_PADDING +
            VIEW_BUTTON_SIZE + 5;
    ...
    inline static const auto COLOR_CURRENT_TEXT_NAME =
            QStringLiteral("#0078D4");
    inline static const auto COLOR_CURRENT_TEXT_ARTIST =
            QStringLiteral("#005999");
    inline static const auto COLOR_SELECTED_BACKGROUND =
            QStringLiteral("#E0E0E0");

    inline static const auto FONT_MIRC_HEI = QStringLiteral("Microsoft YaHei");
    inline static const auto TitleFontNormal = QFont(FONT_MIRC_HEI
                                                         , NAME_FONT_SIZE
                                                         , QFont::Normal);
    inline static const auto TitleFontBold = QFont(FONT_MIRC_HEI
                                                   , NAME_FONT_SIZE
                                                   , QFont::Bold);
    inline static const auto ArtistFontNormal = QFont(FONT_MIRC_HEI
        , ARTIST_FONT_SIZE
        , QFont::Normal);
    inline static const auto ArtistFontBold = QFont(FONT_MIRC_HEI
                                                    , ARTIST_FONT_SIZE
                                                    , QFont::Bold);
};
}
