...
void ViewDelegate::drawText(QPainter* painter
                            , const QFont& font
                            , const QColor& color
                            , const int x
                            , const int y
...
bool ViewDelegate::editorEvent(QEvent* event
                               ...
                               , const QModelIndex& index)
{
    ...
    const QRect buttonOptionsRect(option.rect.right() - VIEW_ADD_BUTTON_PADDING
                                  , option.rect.center().y() - VIEW_BUTTON_SIZE
                                  / 2
                                  , VIEW_BUTTON_SIZE
                                  , VIEW_BUTTON_SIZE);
    const bool isCurrent = (index.row() == m_previousIndex);
    ...
    case QEvent::MouseMove: {
        ...
        {
            if (const QModelIndex currentIndex = view->indexAt(pos);
                currentIndex != m_hoverIndex)
            {
    ...
    case QEvent::MouseButtonRelease: {
        ...
        if (const bool isHoveredMouse = (index == m_hoverIndex); isCurrent ||
            isHoveredMouse)
        {
