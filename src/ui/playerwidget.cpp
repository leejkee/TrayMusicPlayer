...
namespace Tray::Ui {
    ...
    void PlayerWidget::initCenterLayout() {
        m_pushButtonPlay = new Panel::StyleButton({{}, Res::PlayIconSVG, Res::BUTTON_NORMAL_QSS, 30, 30}, this);
        m_pushButtonPre = new Panel::StyleButton({{}, Res::PreIconSVG, Res::BUTTON_NORMAL_QSS, 30, 30}, this);
        m_pushButtonNext = new Panel::StyleButton({{}, Res::NextIconSVG, Res::BUTTON_NORMAL_QSS, 30, 30}, this);
        m_checkPlayMode = new Panel::StyleButton({{}, Res::SequentialModeSVG, Res::BUTTON_NORMAL_QSS, 30, 30}, this);
    ...
    void PlayerWidget::initVolumeControl() {
        ...
        m_pushButtonVolume = new Panel::StyleButton({{}, Res::VolumeBtnSVG, Res::BUTTON_VOLUME_QSS, 30, 30}, this);
