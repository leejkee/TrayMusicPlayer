//
// Created by cww on 25-5-11.
//
#pragma once
#include <QString>

namespace Tray::Res {
    inline const auto TrayIconSVG = QStringLiteral(":/images/MusicPlayerLogo.svg");
    ...
    inline const auto VolumeBtnSVG = QStringLiteral(":/images/volumeBtn.svg");
    inline const auto VolumeMuteSVG = QStringLiteral(":/images/volumeMute.svg");
    ...
    inline const auto ShuffleModeSVG = QStringLiteral(":/images/shuffleList.svg");
    inline const auto LoopAllModeSVG = QStringLiteral(":/images/loopList.svg");
