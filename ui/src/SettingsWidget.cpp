...
SettingsWidget::SettingsWidget(QWidget *parent) : QWidget(parent) {
    ...
    // connect(this, &SettingsWidget::signalAddButton, &Settings::instance(), &Settings::addLocalMusicDirectory);
    // connect(this, &SettingsWidget::signalRemoveButton, &Settings::instance(), &Settings::removeMusicDirectory);
}
